        ...
        for file_path in agent_files:
            try:
                ...
                for name, obj in inspect.getmembers(module):
                    # Check if class has 'run' method and 'Agent' in name (supports both Agent and AgentWeaponized naming)
                    if inspect.isclass(obj) and hasattr(obj, 'run') and 'Agent' in name and name != "BaseAgent":
