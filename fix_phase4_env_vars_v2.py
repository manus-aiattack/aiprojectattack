...
def fix_env_vars(filepath: Path) -> Tuple[bool, int]:
    ...
    try:
        ...
        for i, line in enumerate(lines):
            # ข้าม if statements และ condition checks
            if 'if not os.getenv' in line or 'if os.getenv' in line:
                continue
            ...
            if match:
                ...
                if 'URL' in var_name or 'PATH' in var_name or 'DIR' in var_name:
                    ...
                    default = '"120"'
                elif 'WEBHOOK' in var_name or 'EMAIL' in var_name or 'CHAT_ID' in var_name:
                    default = '""'
                else:
                    default = '""'
